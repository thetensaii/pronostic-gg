...
export default class extends BaseSeeder {
  ...
  async run() {
    ...
    const structures = await StructureModel.updateOrCreateMany(
      ['name'],
      [
        {
          id: crypto.randomUUID(),
    ...
    const teams = await TeamModel.updateOrCreateMany(
      ['name'],
      [
        {
          id: crypto.randomUUID(),
    ...
    await lfl.related('teams').attach(
    ...
    await MatchModel.updateOrCreateMany(
      ['competitionId', 'teamAId', 'teamBId'],
      [
        {
          id: crypto.randomUUID(),
