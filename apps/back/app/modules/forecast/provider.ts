...
export default class ForecastProvider {
  ...
  register() {
    ...
    this.app.container.singleton(MatchService, () => this.app.container.make(DbMatchService))

    this.app.container.singleton(ForecastRepository, () =>
      this.app.container.make(DbForecastRepository)
    )

    this.app.container.singleton(SaveForecastUseCase, () => this.app.container.make(SaveForecast))
  }
}
