...
export class Forecast {
  ...
  static create(props: CreateForecastProps): ResultType<Forecast, ScoreIsNotPossibleError | CannotSaveForecastAnymoreError> {
  ...
  public setScore(score: Score): ResultType<null, ScoreIsNotPossibleError | CannotSaveForecastAnymoreError> {
  ...
  private static validateForecast(matchStartAt: Date, score: Score): ResultType<null, ScoreIsNotPossibleError | CannotSaveForecastAnymoreError>{
  ...
  private static canStillSaveForecast(matchStartAt: Date): ResultType<null, CannotSaveForecastAnymoreError> {
