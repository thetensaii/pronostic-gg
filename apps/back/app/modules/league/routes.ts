...
const GetJoinedCompetitionLeaguesController = () =>
  import('./controller/GetJoinedCompetitionLeaguesController.js')

export const leagueRouter = () =>
  router
    .group(() => {
      router.post('/', [CreateLeagueController]), router.post('/join', [JoinLeagueController])
